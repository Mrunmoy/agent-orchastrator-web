...
- Update project docs as HTML storybook chapters:
  - design page in `docs/design/*.html`
  - playbook page in `docs/playbook/*.html`
  - saga page in `docs/saga/*.html`
...
1) Changes made
2) Tests run + results
3) Docs updated (HTML file paths for design/playbook/saga)
